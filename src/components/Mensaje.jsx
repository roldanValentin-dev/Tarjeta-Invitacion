function Mensaje() {
  return (
    <div className="text-center mb-5 sm:mb-6 md:mb-8 bg-gradient-to-br from-amber-50/90 to-amber-100/50 rounded-2xl p-4 sm:p-5 md:p-6 border border-amber-200/60 shadow-inner">
      <p className="font-serif text-base sm:text-lg md:text-xl lg:text-2xl text-stone-700 italic leading-relaxed">
        ...
        <span className="bounce-gentle block text-2xl sm:text-3xl mt-1 sm:mt-2">😉</span>
      </p>
    </div>
  )
}
